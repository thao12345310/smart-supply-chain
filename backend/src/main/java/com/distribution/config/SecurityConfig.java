...
public class SecurityConfig {
     ...
     * Lấy từ biến môi trường CORS_ALLOWED_ORIGINS (application.yml -> app.cors.allowed-origins),
     * nhiều origin ngăn cách bằng dấu phẩy. Mặc định là frontend dev local.
     */
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Cho phép cấu hình nhiều origin qua biến môi trường, ngăn cách bằng dấu phẩy.
        // Ví dụ prod: "https://my-app.vercel.app,http://localhost:5173"
