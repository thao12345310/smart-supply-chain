...
export default function LoginPage() {
  ...
  const containerStyle = {
    ...
    alignItems: 'center',
    minHeight: '100vh',
    background: 'linear-gradient(135deg, #F2F4F5 0%, #DCE8E6 100%)',
    overflow: 'hidden',
    position: 'relative',
  };

  const bgCircles = [
    { size: 400, top: -100, right: -100, color: 'rgba(20, 113, 106, 0.05)' },
    { size: 300, bottom: -50, left: -50, color: 'rgba(20, 113, 106, 0.08)' },
  ];
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <Space direction="vertical">
            <div style={{
              ...
              justifyContent: 'center',
              margin: '0 auto',
              boxShadow: '0 4px 12px rgba(20, 113, 106, 0.3)',
            }}>
            ...
            <Form.Item style={{ marginBottom: 8, marginTop: 12 }}>
              <Button 
                ...
                style={{ 
                  ...
                  fontSize: 16, 
                  fontWeight: 600,
                  boxShadow: '0 4px 10px rgba(20, 113, 106, 0.2)',
                }}
              >
                Đăng nhập
              </Button>
