// Shared axios instance (base URL, JWT request interceptor, ApiResponse/401-403
// response handling) lives in ./client. This module only declares the per-domain
// API namespaces built on top of it.
