...
\restrict l1wuIgQ4osT5QtFBfmYHdVsqzNjBALRpsuKLxey4Vf6L9P4o2bj2tRQGNhV5Hn4
...
CREATE TABLE public.delivery_triproute (
    ...
    CONSTRAINT delivery_triproute_status_check CHECK (((status)::text = ANY ((ARRAY['CREATED'::character varying, 'IN_PROGRESS'::character varying, 'COMPLETED'::character varying, 'CANCELLED'::character varying])::text[])))
);
...
CREATE TABLE public.goods_issue (
    ...
    warehouse_id bigint,
    CONSTRAINT goods_issue_status_check CHECK (((status)::text = ANY ((ARRAY['DRAFT'::character varying, 'CONFIRMED'::character varying, 'CANCELLED'::character varying])::text[])))
);
...
CREATE TABLE public.goods_receipt (
    ...
    warehouse_id bigint,
    CONSTRAINT goods_receipt_status_check CHECK (((status)::text = ANY ((ARRAY['DRAFT'::character varying, 'CONFIRMED'::character varying, 'CANCELLED'::character varying])::text[])))
);
...
CREATE TABLE public.inventory_transaction (
    ...
    product_id bigint NOT NULL,
    warehouse_id bigint NOT NULL,
    CONSTRAINT inventory_transaction_transaction_type_check CHECK (((transaction_type)::text = ANY ((ARRAY['RECEIPT'::character varying, 'ISSUE'::character varying, 'TRANSFER_IN'::character varying, 'TRANSFER_OUT'::character varying, 'ADJUSTMENT_PLUS'::character varying, 'ADJUSTMENT_MINUS'::character varying, 'RETURN_IN'::character varying, 'RETURN_OUT'::character varying])::text[])))
);
...
CREATE TABLE public.purchase_order (
    ...
    warehouse_id bigint,
    CONSTRAINT purchase_order_status_check CHECK (((status)::text = ANY ((ARRAY['ORDER_OPEN'::character varying, 'ORDER_APPROVED'::character varying, 'ORDER_PARTIALLY_RECEIVED'::character varying, 'ORDER_COMPLETED'::character varying, 'ORDER_CANCELLED'::character varying])::text[])))
);
...
CREATE TABLE public.sales_invoice (
    ...
    goods_issue_id bigint NOT NULL,
    sales_order_id bigint NOT NULL,
    CONSTRAINT sales_invoice_status_check CHECK (((status)::text = ANY ((ARRAY['DRAFT'::character varying, 'ISSUED'::character varying, 'PARTIALLY_PAID'::character varying, 'PAID'::character varying, 'CANCELLED'::character varying, 'OVERDUE'::character varying])::text[])))
);
...
CREATE TABLE public.sales_order (
    ...
    delivery_address_id bigint,
    warehouse_id bigint,
    CONSTRAINT sales_order_payment_status_check CHECK (((payment_status)::text = ANY ((ARRAY['UNPAID'::character varying, 'PARTIALLY_PAID'::character varying, 'PAID'::character varying, 'REFUNDED'::character varying])::text[]))),
    CONSTRAINT sales_order_status_check CHECK (((status)::text = ANY ((ARRAY['ORDER_OPEN'::character varying, 'ORDER_APPROVED'::character varying, 'ORDER_PARTIALLY_DELIVERED'::character varying, 'ORDER_COMPLETED'::character varying, 'ORDER_CANCELLED'::character varying])::text[])))
);
...
1	8500000.00	\N	2026-03-15 00:00:00	13	18	5	3	10	2026-03-28 18:26:55.16767	\N	1	1
2	450000.00	\N	2026-03-15 00:00:00	150	180	30	50	100	2026-03-28 18:26:55.16767	\N	2	1
3	12000000.00	\N	2026-03-15 00:00:00	3	5	2	2	5	2026-03-28 18:26:55.16767	\N	3	1
4	95000.00	\N	2026-02-26 00:00:00	1900	2200	300	500	1000	2026-03-28 18:26:55.16767	\N	4	1
5	180000.00	\N	2026-02-26 00:00:00	800	1000	200	200	500	2026-03-28 18:26:55.16767	\N	5	1
6	45000000.00	\N	2026-03-10 00:00:00	4	6	2	2	5	2026-03-28 18:26:55.16767	\N	6	2
7	320000.00	\N	2026-03-10 00:00:00	90	110	20	30	100	2026-03-28 18:26:55.16767	\N	7	2
8	280000.00	\N	2026-02-25 00:00:00	330	380	50	100	200	2026-03-28 18:26:55.16767	\N	8	1
9	350000.00	\N	2026-02-25 00:00:00	190	220	30	80	150	2026-03-28 18:26:55.16767	\N	9	1
10	650000.00	\N	2026-02-28 00:00:00	340	420	80	100	200	2026-03-28 18:26:55.16767	\N	10	2
11	1200000.00	\N	2026-02-28 00:00:00	150	190	40	50	100	2026-03-28 18:26:55.16767	\N	11	2
12	280000.00	\N	2026-02-22 00:00:00	900	1100	200	300	500	2026-03-28 18:26:55.16767	\N	12	1
13	1850000.00	\N	2026-02-22 00:00:00	90	110	20	30	80	2026-03-28 18:26:55.16767	\N	13	1
14	980000.00	\N	2026-03-03 00:00:00	130	160	30	40	100	2026-03-28 18:26:55.16767	\N	14	1
15	2200000.00	\N	2026-03-03 00:00:00	48	58	10	15	30	2026-03-28 18:26:55.16767	\N	15	1
16	18500000.00	\N	2026-03-05 00:00:00	6	8	2	3	5	2026-03-28 18:26:55.16767	\N	16	3
17	850000.00	\N	2026-03-05 00:00:00	70	85	15	20	50	2026-03-28 18:26:55.16767	\N	17	3
18	95000.00	\N	2026-03-07 00:00:00	370	450	80	100	200	2026-03-28 18:26:55.16767	\N	18	2
19	45000.00	\N	2026-03-07 00:00:00	850	1000	150	200	500	2026-03-28 18:26:55.16767	\N	19	2
20	85000.00	\N	2026-03-06 00:00:00	660	760	100	200	500	2026-03-28 18:26:55.16767	\N	20	1
21	4500000.00	\N	2026-03-06 00:00:00	19	24	5	5	15	2026-03-28 18:26:55.16767	\N	21	1
22	180000.00	\N	2026-03-06 00:00:00	190	230	40	50	150	2026-03-28 18:26:55.16767	\N	22	1
23	1200000.00	\N	2026-03-15 00:00:00	20	25	5	5	20	2026-03-28 18:26:55.16767	\N	23	1
24	380000.00	\N	2026-03-15 00:00:00	60	70	10	20	50	2026-03-28 18:26:55.16767	\N	24	1
25	320000.00	\N	2026-01-25 00:00:00	15	18	3	5	20	2026-03-28 18:26:55.16767	\N	25	2
...
31	\N	\N	SO-1774707482512	\N	2026-03-28 21:18:02.518513	\N	0.00	2026-03-29	0.00		2026-03-28		UNPAID	\N	0.00	ORDER_OPEN	0.00	0.00	2026-03-28 21:18:02.518518	1	18	2
32	\N	\N	SO-1775271186725	\N	2026-04-04 09:53:06.735378	\N	0.00	2026-04-05	0.00		2026-04-04	Đơn hàng 01	UNPAID	\N	0.00	ORDER_OPEN	0.00	0.00	2026-04-04 09:53:06.735385	10	12	1
\.
...
81	6000000.00	0	0.00		5	600000.00	10.00	6600000.00	\N	1200000.00	11	31
82	12000000.00	0	0.00		1	1200000.00	10.00	13200000.00	\N	12000000.00	3	32
\.
...
6	t	admin@distribution.local	System Administrator	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	admin
7	t	purchase.staff@distribution.local	Purchase Staff User	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	purchase_staff
8	t	purchase.manager@distribution.local	Purchase Manager User	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	purchase_manager
9	t	sales.staff@distribution.local	Sales Staff User	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	sales_staff
10	t	sales.manager@distribution.local	Sales Manager User	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	sales_manager
11	t	warehouse.staff@distribution.local	Warehouse Staff User	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	warehouse_staff
12	t	delivery.admin@distribution.local	Delivery Admin User	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	delivery_admin
13	t	shipper1@distribution.local	Shipper One	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	shipper1
14	t	shipper2@distribution.local	Shipper Two	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	shipper2
15	t	accountant@distribution.local	Accountant User	$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy	accountant
...
SELECT pg_catalog.setval('public.delivery_order_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.delivery_plan_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.delivery_plan_order_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.delivery_plan_shipper_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.delivery_triproute_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.delivery_triproute_item_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.goods_issue_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.goods_issue_item_id_seq', 58, true);
...
SELECT pg_catalog.setval('public.goods_receipt_id_seq', 23, true);
...
SELECT pg_catalog.setval('public.goods_receipt_item_id_seq', 54, true);
...
SELECT pg_catalog.setval('public.inventory_transaction_id_seq', 111, true);
...
SELECT pg_catalog.setval('public.purchase_order_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.purchase_order_item_id_seq', 71, true);
...
SELECT pg_catalog.setval('public.sales_invoice_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.sales_invoice_item_id_seq', 58, true);
...
SELECT pg_catalog.setval('public.sales_order_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.sales_order_item_id_seq', 82, true);
...
\unrestrict l1wuIgQ4osT5QtFBfmYHdVsqzNjBALRpsuKLxey4Vf6L9P4o2bj2tRQGNhV5Hn4
