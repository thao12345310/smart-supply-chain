...
% Document body uses ragged bottom: the thesis is figure/table-dense, so vertical
% glue must not be stretched to force a flush bottom (this is what produced large
% gaps between a top table/figure and the following paragraph). Leftover space is
% allowed to fall naturally to the bottom of the page instead.
\raggedbottom
