...
DB migration            & SQL migration scripts   & V1--V8 \\ \hline
...
Lines of code (backend) & 15,461 \\ \hline
Lines of code (frontend) & 10,991 \\ \hline
Number of Java classes & 157 \\ \hline
Number of packages & 12 \\ \hline
\end{tabular}
\end{table}
...
reporting, authentication, and user-role management. Table~\ref{tab:loc}
summarises the source-code statistics. The backend source code has 15,461 Java
lines in 157 classes under \texttt{backend/src/main/java}, organised into 12
packages. The frontend source code has 10,991 JavaScript/JSX lines under
\texttt{frontend/src}. These values were computed from the project source tree.
