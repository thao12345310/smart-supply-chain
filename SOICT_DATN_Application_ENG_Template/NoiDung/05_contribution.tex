...
are inherently conflicting and must be ordered for correctness. A deterministic
two-thread integration test that drives both confirmations through a shared
barrier is identified as future work to provide an automated regression guard
for this behaviour.
