...
The backend follows a layered architecture, an established enterprise
application pattern that separates presentation, domain logic, and data
access~\cite{fowler2002poeaa}. Controllers receive HTTP requests
